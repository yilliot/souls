...
return [
    ...
    'formatters' => [
        ...
        SymfonyException\HttpException::class => App\Exceptions\Formatters\HttpExceptionFormatter::class,
        Exception::class => App\Exceptions\Formatters\ExceptionFormatter::class,
    ],
