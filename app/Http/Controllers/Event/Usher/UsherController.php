...
class UsherController extends Controller
{
    ...
    public function getnewcomer(Request $request)
    {
        ...
        return view('event.usher.newcomer', compact('newcomerdetails', 'followuplists'));
    }
    ...
    public function getfollowup(Request $request)
    {
        ...
        return view('event.usher.followup', compact('newcomerdetails', 'followuplists'));
    }

    public function getfeedback(Request $request)
    {

        return view('event.usher.feedback');
    }

    public function detail(Request $request)
    {

        return view('event.usher.detail');
    }
}