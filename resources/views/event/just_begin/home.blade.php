    ...
    @forelse ($records as $record)
      <div class="item">
        <div class="content">
          ...
          {{$record->soul->nickname}} : <a href="#" data-featherlight="/storage/{{$record->screenshot_path}}">{{number_format($record->meters/1000)}}km ({{(number_format($record->meters/1000) / ($record->minutes/60))}}km/h)</a>
        </div>
      </div>
    @empty
      <div class="item">
